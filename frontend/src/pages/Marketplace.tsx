...
const DEMO_PRODUCTS: Product[] = [
  { id: 'anima-1', name: 'ANIMA 119 - Thức Thể Phân Tử Sống (1 Hộp)', price: 1868000, originalPrice: undefined, category: 'food', dpp: false, rating: 0, sold: 0, kocAvatar: '', kocName: 'AnimaCare Global', gradient: 'linear-gradient(135deg, #14532d, #065f46)', imageUrl: '/images/anima119-hero.jpg' },
  { id: 'anima-2', name: 'ANIMA 119 - Liệu Trình 3 Hộp (30 Gói)', price: 5604000, originalPrice: undefined, category: 'food', dpp: false, rating: 0, sold: 0, kocAvatar: '', kocName: 'AnimaCare Global', gradient: 'linear-gradient(135deg, #1e3a5f, #0c4a6e)', imageUrl: '/images/anima119-hero.jpg' },
  { id: 'anima-3', name: 'ANIMA 119 - Phục Hưng Toàn Diện 12 Hộp (120 Gói)', price: 22416000, originalPrice: undefined, category: 'food', dpp: false, rating: 0, sold: 0, kocAvatar: '', kocName: 'AnimaCare Global', gradient: 'linear-gradient(135deg, #4c1d95, #2d1b69)', imageUrl: '/images/anima119-hero.jpg' },
...
export default function Marketplace() {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      const res = await Promise.race([productsApi.list(params), timeout]);
      ...
      // keep existing products (DEMO_PRODUCTS or previously loaded)
    }
